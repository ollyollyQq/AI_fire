...
public class RegisterActivity extends AppCompatActivity {
    ...
    private Runnable sign_up = new Runnable(){
        public void run()
        {
            try {
                TextView account;
                ...
                String param = "key=sign_up"+"&account="+account.getText().toString()+"&password="+password.getText().toString()+"&name="+name.getText().toString()+"&email="+email.getText().toString()+"&phone="+phone.getText().toString()+"&age="+age.getText().toString();
                ...
                if(responseCode == HttpURLConnection.HTTP_OK){
                    ...
                    if(key.equals("1"))
                    {
                        ...
                        Intent intent = new Intent();
                        try {
                            intent.putExtra("account",j.getString("account"));
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(RegisterActivity.this, result, Toast.LENGTH_SHORT).show(); // 更改顯示文字 更改顯示文字
                    result = "";
                }
            });
        }
